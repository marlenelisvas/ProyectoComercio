     ...
     //=====================================================================    
        ...
        ConexionJDBC _con = new ConexionJDBC();  
         ...
         try {
                ...
                ResultSet res = query.executeQuery("Select * from template");
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btn_eliminarTemplate, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btn_cargarPlantillaImportacion)
                    .addComponent(lbl_nombreTemplate, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btn_cargarPlantillaImportacion, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void btn_cargarPlantillaImportacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cargarPlantillaImportacionActionPerformed
       ...
       String nombre = JOptionPane.showInputDialog(null, "Nombre", "");
        ...
        if(estado == JFileChooser.APPROVE_OPTION){
            ...
            Template temp = new Template(null, nombre, archivo);
